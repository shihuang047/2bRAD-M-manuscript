...
# T is for enable metagenomic sequencing data generating, 100000 is the totoal number of reads.
# Genome_ref and Wgsim are necessary for the script, please run the shell "genomes_download.sh" in "Genome_ref" first.
